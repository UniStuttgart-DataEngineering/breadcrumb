...
object LocalRelationRewrite {
  def apply(localRelation: LocalRelation, whyNotQuestion:SchemaSubsetTree, oid: Int)  = new LocalRelationRewrite(localRelation, whyNotQuestion, oid)
}

class LocalRelationRewrite(localRelation: LocalRelation, whyNotQuestion:SchemaSubsetTree, oid: Int) extends TransformationRewrite(localRelation, whyNotQuestion, oid){
